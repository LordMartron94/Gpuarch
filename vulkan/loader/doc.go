...
VulkanDeviceCommandsLoad to populate an entire holder, or build a VulkanCommandManifest at runtime and call
VulkanCommandsLoadManifest to bind only the entry points you need (typed helpers VulkanCommandManifestAdd* in
loader_manifest_gen.go). Holder fields include Khronos man page documentation for LSP hover on the command entry
points clients use directly.
*/
package loader
