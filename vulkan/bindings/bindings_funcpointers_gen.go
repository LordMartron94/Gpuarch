...
*/
type PFN_vkDebugReportCallbackEXT func(flags VkDebugReportFlagsEXT, objectType VkDebugReportObjectTypeEXT, object uint64, location uintptr, messageCode int32, pLayerPrefix *byte, pMessage *byte, pUserData unsafe.Pointer) VkBool32
...
*/
type PFN_vkDebugUtilsMessengerCallbackEXT func(messageSeverity VkDebugUtilsMessageSeverityFlagsEXT, messageTypes VkDebugUtilsMessageTypeFlagsEXT, pCallbackData *VkDebugUtilsMessengerCallbackDataEXT, pUserData unsafe.Pointer) VkBool32
...
*/
type PFN_vkFaultCallbackFunction func(unrecordedFaults VkBool32, faultCount uint32, pFaults *VkFaultData)
