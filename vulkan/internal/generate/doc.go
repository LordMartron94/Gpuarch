...
Binding generation uses three documentation tiers:
  ...
  - Loader: ../loader/loader_commands_gen.go exposes VulkanCommands (semantic endpoint sub-structs with Khronos
    man page docs on each field), VulkanCommandsLoadGlobal/Instance/Device, and VulkanCommandManifestAdd* helpers.
